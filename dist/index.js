...
exports.buildTestHtmlPage = exports.brfs = exports.minify = exports.browserify = exports.tsc = exports.prepareForWatching = void 0;
...
const fork = (modulePath, args, options, onStdoutData) => new Promise((resolve, reject) => {
    if (!!onStdoutData) {
        options = Object.assign(Object.assign({}, (options || {})), { "silent": true });
    }
